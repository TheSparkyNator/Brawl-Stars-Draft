#Code made by: u/TheSparkyNator. V 1.2 of Brawl Stars Draft
import random
ABI = int(0)
c = int(0)
l = int(0)
...
bannew = input("Ban Rosa? Y/N ")
allowdupes = input("Allow Duplicate Brawlers? Y/N ")
...
if includetroads == "Y" or includetroads == "y":
    ...
    pass
if bannew == "Y" or bannew == "y":
    for i in range(5):
        brawlers.remove("Rosa")
else:
    pass
...
for i in range(players):
    for i in range(runcount):
        ...
        if brawlerdrafted == "Crow" or brawlerdrafted == "Spike" or brawlerdrafted == "Leon":
            ABI = brawlers.count(brawlerdrafted)
            if allowdupes == "Y" or allowdupes == "y":
